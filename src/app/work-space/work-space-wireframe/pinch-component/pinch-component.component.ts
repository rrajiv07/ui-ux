import {ChangeDetectorRef, Component, ElementRef, EventEmitter, HostBinding, HostListener, Input, Output, OnDestroy, SimpleChanges, OnInit} from '@angular/core';
...
@Component({
  selector: 'app-pinch-component',
  templateUrl: './pinch-component.component.html',
  styleUrls: ['./pinch-component.component.css']
})
export class PinchComponentComponent implements OnInit {
